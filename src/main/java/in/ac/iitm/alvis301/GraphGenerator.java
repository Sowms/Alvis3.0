...
public class GraphGenerator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Graph Generator");

        jLabel3.setText("Sparse/Dense:");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Sparse", "Dense" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String density = (String) jComboBox1.getSelectedItem();
        ...
        gw.setTitle("Graph");
        gw.density = density;
        GraphWindow.setInstance(gw);
        gw.setExtendedState(getExtendedState() | JFrame.MAXIMIZED_BOTH);
        this.dispose();
